 ...
 * 
 * This header file impliments the functions required to apply this block cipher
 * to a single block. Applying it to multiple blocks is the responsability of
 * crypto.c
*******************************************************************************/
#ifndef CRYPTOHEADER
#define CRYPTOHEADER
